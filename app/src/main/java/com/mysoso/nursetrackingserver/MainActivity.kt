...
import com.mysoso.nursetrackingserver.database.database.PhyathaiDatabase
...
import com.mysoso.nursetrackingserver.ui.home.HomeFragment
...
//    }
    ...
    suspend fun reVersionDb(database: PhyathaiDatabase) {
        database.let { db ->
            withContext(Dispatchers.IO) {
                val settingRegisterVersionDao = db?.settingRegisterVersionDao()

                settingRegisterVersionDao.deleteAll()

//                settingRegisterVersionDao.createVersion(
//                    SettingRegisterVersion(
//                        setting_register_version_title = "brand",
//                        setting_register_version_number = "0000001"
//                    )
//                )
